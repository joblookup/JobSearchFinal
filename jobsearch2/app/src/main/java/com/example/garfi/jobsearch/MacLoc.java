...
import com.tomtom.online.sdk.map.MapLayers;
import com.tomtom.online.sdk.map.MapTiles;
import com.tomtom.online.sdk.map.Marker;
import com.tomtom.online.sdk.map.MarkerBuilder;
import com.tomtom.online.sdk.map.MarkerSettings;
import com.tomtom.online.sdk.map.OnMapReadyCallback;
import com.tomtom.online.sdk.map.OverlaySettings;
...
public class MacLoc extends AppCompatActivity implements OnMapReadyCallback,
                ...
                .subscribe(new DisposableSingleObserver<ReverseGeocoderSearchResponse>() {
                    ...
                    private void processResponse(ReverseGeocoderSearchResponse response) {
                        if (response.hasResults()) {
                            ...
                            Toast.makeText(MacLoc.this, getString(R.string.geocode_no_results), Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void handleApiError(Throwable e) {
        Toast.makeText(MacLoc.this, getString(R.string.api_response_error, e.getLocalizedMessage()), Toast.LENGTH_LONG).show();
    }
    ...
    private void initUIViews() {
        departureIcon = Icon.Factory.fromResources(MacLoc.this, R.drawable.ic_map_route_departure);
        destinationIcon = Icon.Factory.fromResources(MacLoc.this, R.drawable.ic_map_route_destination);
                        ...
                        .subscribe(new DisposableSingleObserver<AlongRouteSearchResponse>() {
                            ...
                            private void displaySearchResults(List<AlongRouteSearchResult> results) {
                                if (!results.isEmpty()) {
                                    ...
                                    Toast.makeText(MacLoc.this, String.format(getString(R.string.no_search_results), textToSearch), Toast.LENGTH_LONG).show();
                                }
                            }
